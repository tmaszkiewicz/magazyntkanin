...
urlpatterns = [
    ...
    url(r'^login_m/(?P<nr_zamowienia>[0-9]+)/(?P<nr_tkaniny>[0-9]+)/$', views.user_login_m, name='login_m'),
    url(r'^l_check/(?P<nr_rolki>[0-9]+)/$', views.l_check, name='l_check'),
    url(r'^l_check_m/(?P<nr_zamowienia>[0-9]+)/(?P<nr_tkaniny>[0-9]+)/$', views.l_check_m, name='l_check_m'),
    ...
    url(r'^magazyn/inwentura_g2/$', views.magazyn_inwentura_grupowana_v2, name='inwentura_g2'),
    ...
    url(r'^magazyn/wz_xls/$', views.wz_xls, name='wz_xls'),
    ...
    url(r'^magazyn/usun_tk_dost_/(?P<nr_zamowienia>[0-9]+)/(?P<nr_tkaniny>[0-9]+)/(?P<user>.+)/$', views.usun_tk_dost_, name='usun_tk_dost_'),
